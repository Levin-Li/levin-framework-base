 ...
 *  字典-业务服务实现类
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月28日 下午6:09:28, 代码生成哈希校验码：[0b271b4b11ae4ca042759551f3291960]，请不要修改和删除此行内容。
 *
 */
...
@Service(PLUGIN_PREFIX + "BizDictService")

@ConditionalOnProperty(prefix = PLUGIN_PREFIX, name = "BizDictService", havingValue = "true", matchIfMissing = true)
@Slf4j
