...
import static com.levin.oak.base.services.accesslog.AccessLogService.*;
 ...
 *  访问日志-业务服务实现类
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月17日 上午10:43:54, 代码生成哈希校验码：[89add129e84e9963a24250329bbb3871]，请不要修改和删除此行内容。
 *
 */
...
@Service(PLUGIN_PREFIX + "BizAccessLogService")

@ConditionalOnProperty(prefix = PLUGIN_PREFIX, name = "BizAccessLogService", havingValue = "true", matchIfMissing = true)
@Slf4j
