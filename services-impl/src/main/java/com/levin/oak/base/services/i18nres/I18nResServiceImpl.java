 ...
 * 国际化资源-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月23日 下午11:55:36, 代码生成哈希校验码：[1ab8c2f7533130dee14ab2ea88dfed05]，请不要修改和删除此行内容。
 *
 */
...
public class I18nResServiceImpl extends BaseService implements I18nResService {
    ...
    @Override
    //@CacheEvict(condition = "#isNotEmpty(#req.id) && #result", key = E_I18nRes.CACHE_KEY_PREFIX + "#req.id")
    @Transactional
