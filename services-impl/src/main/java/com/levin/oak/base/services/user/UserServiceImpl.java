 ...
 * 用户-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月23日 下午11:55:35, 代码生成哈希校验码：[707c589c19ad16afe9f48cc0c8de0a50]，请不要修改和删除此行内容。
 *
 */
...
public class UserServiceImpl extends BaseService implements UserService {
    ...
    @Override
    //@CacheEvict(condition = "#isNotEmpty(#req.id) && #result", key = E_User.CACHE_KEY_PREFIX + "#req.id")
    @Transactional
    ...
    @Override
    //@Cacheable(condition = "#isNotEmpty(#id)", unless = "#result == null ", key = E_User.CACHE_KEY_PREFIX + "#id")
    ...
    @Override
    //只更新缓存
    //@CachePut(unless = "#result == null" , condition = "#isNotEmpty(#req.id)" , key = E_User.CACHE_KEY_PREFIX + "#req.id")
