 ...
 * 应用接入-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:07, 代码生成哈希校验码：[c3de833384a7f0efcc6dbe3bb3e054c7]，请不要修改和删除此行内容。
 *
 */
...
public class AppClientServiceImpl extends BaseService<AppClientServiceImpl> implements AppClientService {
    ...
    */
    ...
    /**
    * 清除[AppClientService.CACHE_NAME]缓存中的所有缓存
    *
    */
    @Override
