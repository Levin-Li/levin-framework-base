...
import static com.levin.oak.base.services.accesswhitelist.AccessWhitelistService.*;
 ...
 *  访问白名单-业务服务实现类
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月9日 下午10:46:12, 代码生成哈希校验码：[a3b474e496d189d101e9ed13731e846a]，请不要修改和删除此行内容。
 *
 */
...
@Service(PLUGIN_PREFIX + "BizAccessWhitelistService")

@ConditionalOnProperty(prefix = PLUGIN_PREFIX, name = "BizAccessWhitelistService", havingValue = "true", matchIfMissing = true)
@Slf4j
...
public class BizAccessWhitelistServiceImpl extends BaseService<BizAccessWhitelistServiceImpl> implements BizAccessWhitelistService {
    ...
    public String create(CreateAccessWhitelistReq req){
        return accessWhitelistService.create(req);
    }
    ...
    public AccessWhitelistInfo findById(String id) {
        return accessWhitelistService.findById(id);
    }
    ...
    public AccessWhitelistInfo findById(AccessWhitelistIdReq req) {
        return accessWhitelistService.findById(req);
    }
    ...
    @Transactional
    public boolean update(UpdateAccessWhitelistReq req) {
        return accessWhitelistService.update(req);
    }
    ...
    public boolean delete(AccessWhitelistIdReq req) {
        return accessWhitelistService.delete(req);
    }
    ...
    */
    ...
    public StatAccessWhitelistReq.Result stat(StatAccessWhitelistReq req, Paging paging){
    ...
    public void clearCache(Object key) {
        accessWhitelistService.clearCache(key);
    }
