 ...
 *  通知-业务服务实现类
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午1:20:14, 代码生成哈希校验码：[2159739abe3f14aa531fda03c8b31063]，请不要修改和删除此行内容。
 *
 */
...
@Service(PLUGIN_PREFIX + "BizNoticeService")

@ConditionalOnProperty(prefix = PLUGIN_PREFIX, name = "BizNoticeService", havingValue = "true", matchIfMissing = true)
@Slf4j
...
public class BizNoticeServiceImpl extends BaseService<BizNoticeServiceImpl> implements BizNoticeService {
