 ...
 * 系统设置-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月17日 上午10:43:54, 代码生成哈希校验码：[fefbea1b51d8ccc9870c1564f11ef114]，请不要修改和删除此行内容。
 *
 */
...
public class SettingServiceImpl extends BaseService implements SettingService {
    ...
    */
    ...
    public int batchUpdate(SimpleUpdateSettingReq setReq, QuerySettingReq whereReq){
