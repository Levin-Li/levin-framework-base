...
import static com.levin.oak.base.services.dynamicverifycodecfg.DynamicVerifyCodeCfgService.*;
 ...
 *  动态验证码配置-业务服务实现类
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月9日 下午10:46:13, 代码生成哈希校验码：[a660313c3d77d64f9c8a99b69ea0ea59]，请不要修改和删除此行内容。
 *
 */
...
@Service(PLUGIN_PREFIX + "BizDynamicVerifyCodeCfgService")

@ConditionalOnProperty(prefix = PLUGIN_PREFIX, name = "BizDynamicVerifyCodeCfgService", havingValue = "true", matchIfMissing = true)
@Slf4j
...
public class BizDynamicVerifyCodeCfgServiceImpl extends BaseService<BizDynamicVerifyCodeCfgServiceImpl> implements BizDynamicVerifyCodeCfgService {

    @Autowired
    DynamicVerifyCodeCfgService dynamicVerifyCodeCfgService;
    ...
    public String create(CreateDynamicVerifyCodeCfgReq req){
        return dynamicVerifyCodeCfgService.create(req);
    }
    ...
    public DynamicVerifyCodeCfgInfo findById(String id) {
        return dynamicVerifyCodeCfgService.findById(id);
    }
    ...
    public DynamicVerifyCodeCfgInfo findById(DynamicVerifyCodeCfgIdReq req) {
        return dynamicVerifyCodeCfgService.findById(req);
    }
    ...
    @Transactional
    public boolean update(UpdateDynamicVerifyCodeCfgReq req) {
        return dynamicVerifyCodeCfgService.update(req);
    }
    ...
    public boolean delete(DynamicVerifyCodeCfgIdReq req) {
        return dynamicVerifyCodeCfgService.delete(req);
    }
    ...
    */
    ...
    public StatDynamicVerifyCodeCfgReq.Result stat(StatDynamicVerifyCodeCfgReq req, Paging paging){
    ...
    public void clearCache(Object key) {
        dynamicVerifyCodeCfgService.clearCache(key);
    }
