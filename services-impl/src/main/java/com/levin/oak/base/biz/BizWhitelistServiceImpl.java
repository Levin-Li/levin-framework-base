...
import static com.levin.oak.base.services.whitelist.WhitelistService.*;
 ...
 *  白名单-业务服务实现类
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月2日 下午8:20:51, 代码生成哈希校验码：[7853319d7daf74dca3b382f3f4e47d69]，请不要修改和删除此行内容。
 *
 */
...
@Service(PLUGIN_PREFIX + "BizWhitelistService")

@ConditionalOnProperty(prefix = PLUGIN_PREFIX, name = "BizWhitelistService", havingValue = "true", matchIfMissing = true)
@Slf4j
...
public class BizWhitelistServiceImpl extends BaseService<BizWhitelistServiceImpl> implements BizWhitelistService {
    ...
    */
    ...
    public StatWhitelistReq.Result stat(StatWhitelistReq req, Paging paging){
    ...
    public void clearCache(Object key) {
        whitelistService.clearCache(key);
    }
