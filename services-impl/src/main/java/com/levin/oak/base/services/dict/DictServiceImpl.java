 ...
 * 字典-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:07, 代码生成哈希校验码：[519c9611c1bdbf04811602922c57c5d3]，请不要修改和删除此行内容。
 *
 */
...
@CacheConfig(cacheNames = DictService.CACHE_NAME, cacheResolver = PLUGIN_PREFIX + "ModuleSpringCacheResolver")

// *** 提示 *** 请尽量不要修改本类，如果需要修改，请在BizDictServiceImpl业务类中重写业务逻辑
...
public class DictServiceImpl extends BaseService<DictServiceImpl> implements DictService {
    ...
    */
    ...
    public int batchUpdate(SimpleUpdateDictReq setReq, QueryDictReq whereReq, Object... queryObjs){
    ...
    public int count(QueryDictReq req, Object... queryObjs){
    ...
    @Operation(summary = QUERY_ACTION)
    @Override
    public DictInfo findOne(QueryDictReq req, Object... queryObjs){
    ...
    */
    ...
    /**
    * 清除[DictService.CACHE_NAME]缓存中的所有缓存
    *
    */
    @Override
