 ...
 * 简单动态接口-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月14日 下午3:54:11, 代码生成哈希校验码：[09beaaec821146522185052105c0215f]，请不要修改和删除此行内容。
 *
 */
...
public class SimpleApiServiceImpl extends BaseService implements SimpleApiService {
    ...
    @Override
    //@CacheEvict(condition = "#isNotEmpty(#req.id)", key = E_SimpleApi.CACHE_KEY_PREFIX + "#req.id")
    @Transactional(rollbackFor = RuntimeException.class)
