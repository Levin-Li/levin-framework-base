 ...
 * 简单动态接口-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年7月27日 下午6:25:41, 代码生成哈希校验码：[80123391cbbd7ebfb98d989da5f4d9ee]，请不要修改和删除此行内容。
 */
...
public class SimpleApiServiceImpl extends BaseService implements SimpleApiService {
    ...
    @CacheEvict(
            ...
            key = E_SimpleApi.CACHE_KEY_PREFIX + "#key")
