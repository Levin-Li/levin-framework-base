 ...
 * 通知-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年7月27日 下午6:25:44, 代码生成哈希校验码：[24630c3a3f614a9acfd2b62afec86a46]，请不要修改和删除此行内容。
 */
...
public class NoticeServiceImpl extends BaseService implements NoticeService {
    ...
    @CacheEvict(
            ...
            key = E_Notice.CACHE_KEY_PREFIX + "#key")
