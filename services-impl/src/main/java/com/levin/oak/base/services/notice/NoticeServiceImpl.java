 ...
 * 通知-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:07, 代码生成哈希校验码：[5c19fe4330b91e2e1fa0fa709d1c94a8]，请不要修改和删除此行内容。
 *
 */
...
@CacheConfig(cacheNames = NoticeService.CACHE_NAME, cacheResolver = PLUGIN_PREFIX + "ModuleSpringCacheResolver")
...
public class NoticeServiceImpl extends BaseService<NoticeServiceImpl> implements NoticeService {
    ...
    */
    ...
    @Transactional
    public boolean update(UpdateNoticeReq req, Object... queryObjs) {
    ...
    @Override
    public PagingData<NoticeInfo> query(QueryNoticeReq req, Paging paging, Object... queryObjs) {
        return simpleDao.findPagingDataByQueryObj(req, paging, queryObjs);
    }

    @Operation(summary = QUERY_ACTION + "-指定列", description = "通常用于字段过多的情况，提升性能")
    public PagingData<NoticeInfo> selectQuery(QueryNoticeReq req, Paging paging, String... columnNames){
        return simpleDao.forSelect(NoticeInfo.class, req, paging).select(columnNames).findPaging(null, paging);
    }
    ...
    */
    ...
    /**
    * 清除[NoticeService.CACHE_NAME]缓存中的所有缓存
    *
    */
    @Override
