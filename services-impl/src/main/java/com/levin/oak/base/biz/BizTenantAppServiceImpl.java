 ...
 *  租户应用-业务服务实现类
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月14日 下午3:54:11, 代码生成哈希校验码：[1dc132a1bec8cd482b005ce00e956dea]，请不要修改和删除此行内容。
 *
 */
...
@Service(PLUGIN_PREFIX + "BizTenantAppServiceImpl")
@DubboService

@ConditionalOnMissingBean({BizTenantAppService.class}) //默认只有在无对应服务才启用
@ConditionalOnProperty(prefix = PLUGIN_PREFIX, name = "BizTenantAppServiceImpl", matchIfMissing = true)
@Slf4j
