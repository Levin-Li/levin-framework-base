 ...
 * 机构-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:08, 代码生成哈希校验码：[bbbe7831c73b50c2af82d8c608cf1939]，请不要修改和删除此行内容。
 *
 */

@Service(OrgService.SERVICE_BEAN_NAME)

@ConditionalOnProperty(name = OrgService.SERVICE_BEAN_NAME, havingValue = "true", matchIfMissing = true)
@Slf4j
...
public class OrgServiceImpl extends BaseService<OrgServiceImpl> implements OrgService {
    ...
    */
    ...
    /**
    * 清除[OrgService.CACHE_NAME]缓存中的所有缓存
    *
    */
    @Override
