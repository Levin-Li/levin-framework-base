 ...
 * 通知处理日志-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月1日 下午3:17:43, 代码生成哈希校验码：[029dbb2670e1fd7723a704946c508f35]，请不要修改和删除此行内容。
 *
 */
...
public class NoticeProcessLogServiceImpl extends BaseService implements NoticeProcessLogService {
    ...
    @Override
    //@CacheEvict(condition = "#isNotEmpty(#req.id)", key = E_NoticeProcessLog.CACHE_KEY_PREFIX + "#req.id")
    @Transactional(rollbackFor = RuntimeException.class)
