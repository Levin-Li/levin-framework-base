 ...
 * 简单页面-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年7月27日 下午6:25:46, 代码生成哈希校验码：[263b35edc5d378578d8358f92d89f667]，请不要修改和删除此行内容。
 */
...
public class SimplePageServiceImpl extends BaseService implements SimplePageService {
    ...
    @CacheEvict(
            ...
            key = E_SimplePage.CACHE_KEY_PREFIX + "#key")
