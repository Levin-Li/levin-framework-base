 ...
 * 简单页面-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:08, 代码生成哈希校验码：[4fa0fa3d6dcb25eea3b28288b73e9c97]，请不要修改和删除此行内容。
 *
 */

@Service(SimplePageService.SERVICE_BEAN_NAME)

@ConditionalOnProperty(name = SimplePageService.SERVICE_BEAN_NAME, havingValue = "true", matchIfMissing = true)
@Slf4j
...
public class SimplePageServiceImpl extends BaseService<SimplePageServiceImpl> implements SimplePageService {
    ...
    */
    ...
    /**
    * 清除[SimplePageService.CACHE_NAME]缓存中的所有缓存
    *
    */
    @Override
