 ...
 * 简单页面-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月14日 下午3:54:12, 代码生成哈希校验码：[e310488859a3391cf678a5fe9501541e]，请不要修改和删除此行内容。
 *
 */
...
public class SimplePageServiceImpl extends BaseService implements SimplePageService {
    ...
    @Override
    //@CacheEvict(condition = "#isNotEmpty(#req.id)", key = E_SimplePage.CACHE_KEY_PREFIX + "#req.id")
    @Transactional(rollbackFor = RuntimeException.class)
