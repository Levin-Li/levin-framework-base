 ...
 * 调度日志-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月23日 下午11:55:35, 代码生成哈希校验码：[40d84cb87f6e99f95640d4600ffa4a97]，请不要修改和删除此行内容。
 *
 */
...
public class ScheduledLogServiceImpl extends BaseService implements ScheduledLogService {
    ...
    @Override
    //@CacheEvict(condition = "#isNotEmpty(#req.id) && #result", key = E_ScheduledLog.CACHE_KEY_PREFIX + "#req.id")
    @Transactional
