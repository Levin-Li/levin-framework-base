 ...
 * 访问日志-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月23日 下午11:55:35, 代码生成哈希校验码：[be7f1395c89289621333818dfa0c52a8]，请不要修改和删除此行内容。
 *
 */
...
public class AccessLogServiceImpl extends BaseService implements AccessLogService {
    ...
    @Override
    //@CacheEvict(condition = "#isNotEmpty(#req.id) && #result", key = E_AccessLog.CACHE_KEY_PREFIX + "#req.id")
    @Transactional
