 ...
 * 调度任务-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月14日 下午3:54:12, 代码生成哈希校验码：[ad1af91d5d56e049b9c2165b4e483148]，请不要修改和删除此行内容。
 *
 */
...
public class ScheduledTaskServiceImpl extends BaseService implements ScheduledTaskService {
    ...
    @Override
    //@CacheEvict(condition = "#isNotEmpty(#req.id)", key = E_ScheduledTask.CACHE_KEY_PREFIX + "#req.id")
    @Transactional(rollbackFor = RuntimeException.class)
