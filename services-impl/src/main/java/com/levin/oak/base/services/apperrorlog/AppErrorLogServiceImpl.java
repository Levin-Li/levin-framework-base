 ...
 * 应用错误日志-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年7月27日 下午6:25:43, 代码生成哈希校验码：[ad9256c28536912620146303b1c18aed]，请不要修改和删除此行内容。
 */
...
public class AppErrorLogServiceImpl extends BaseService implements AppErrorLogService {
    ...
    @CacheEvict(
            ...
            key = E_AppErrorLog.CACHE_KEY_PREFIX + "#key")
