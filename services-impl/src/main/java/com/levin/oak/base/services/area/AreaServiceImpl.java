 ...
 * 区域-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月1日 下午3:17:44, 代码生成哈希校验码：[ddc7d3a571bb0e29496935b79fb2f997]，请不要修改和删除此行内容。
 *
 */
...
public class AreaServiceImpl extends BaseService implements AreaService {
    ...
    @Override
    //@CacheEvict(condition = "#isNotEmpty(#req.code)", key = E_Area.CACHE_KEY_PREFIX + "#req.code")
    @Transactional(rollbackFor = RuntimeException.class)
