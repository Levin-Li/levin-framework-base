 ...
 * 工作岗位-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月17日 上午10:43:55, 代码生成哈希校验码：[2c3996e9f53c55115730a696ca9423cd]，请不要修改和删除此行内容。
 *
 */
...
public class JobPostServiceImpl extends BaseService implements JobPostService {
    ...
    */
    ...
    public int batchUpdate(SimpleUpdateJobPostReq setReq, QueryJobPostReq whereReq){
