 ...
 * 客户端文件-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月14日 下午3:54:12, 代码生成哈希校验码：[7ce44ca4ae022d5bfa92c3eda333593d]，请不要修改和删除此行内容。
 *
 */
...
public class AppClientFileServiceImpl extends BaseService implements AppClientFileService {
    ...
    @Override
    //@CacheEvict(condition = "#isNotEmpty(#req.id)", key = E_AppClientFile.CACHE_KEY_PREFIX + "#req.id")
    @Transactional(rollbackFor = RuntimeException.class)
