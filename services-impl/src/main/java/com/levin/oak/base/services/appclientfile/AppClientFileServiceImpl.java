 ...
 * 客户端文件-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年7月27日 下午6:25:44, 代码生成哈希校验码：[c45662e6344950e7fd3e4ab334960067]，请不要修改和删除此行内容。
 */
...
public class AppClientFileServiceImpl extends BaseService implements AppClientFileService {
    ...
    @CacheEvict(
            ...
            key = E_AppClientFile.CACHE_KEY_PREFIX + "#key")
