 ...
 * 客户端文件-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:07, 代码生成哈希校验码：[b573b8c315ffba69011e167c303feb0b]，请不要修改和删除此行内容。
 *
 */
...
public class AppClientFileServiceImpl extends BaseService<AppClientFileServiceImpl> implements AppClientFileService {
    ...
    */
    ...
    @Override
    public PagingData<AppClientFileInfo> query(QueryAppClientFileReq req, Paging paging, Object... queryObjs) {
    ...
    */
    ...
    /**
    * 清除[AppClientFileService.CACHE_NAME]缓存中的所有缓存
    *
    */
    @Override
