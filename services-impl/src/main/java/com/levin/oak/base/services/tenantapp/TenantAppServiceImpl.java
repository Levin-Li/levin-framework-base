 ...
 * 租户应用-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:07, 代码生成哈希校验码：[1bff980eed6db67595acd65cae446ea5]，请不要修改和删除此行内容。
 *
 */

@Service(TenantAppService.SERVICE_BEAN_NAME)

@ConditionalOnProperty(name = TenantAppService.SERVICE_BEAN_NAME, havingValue = "true", matchIfMissing = true)
@Slf4j
...
@CacheConfig(cacheNames = TenantAppService.CACHE_NAME, cacheResolver = PLUGIN_PREFIX + "ModuleSpringCacheResolver")

// *** 提示 *** 请尽量不要修改本类，如果需要修改，请在BizTenantAppServiceImpl业务类中重写业务逻辑
...
public class TenantAppServiceImpl extends BaseService<TenantAppServiceImpl> implements TenantAppService {
    ...
    */
    ...
    @Transactional
    public boolean update(UpdateTenantAppReq req, Object... queryObjs) {
    ...
    public int batchUpdate(SimpleUpdateTenantAppReq setReq, QueryTenantAppReq whereReq, Object... queryObjs){
    ...
    public PagingData<TenantAppInfo> selectQuery(QueryTenantAppReq req, Paging paging, String... columnNames){
        return simpleDao.forSelect(TenantAppInfo.class, req, paging).select(columnNames).findPaging(null, paging);
    }

    @Override
    @Operation(summary = STAT_ACTION)
    public int count(QueryTenantAppReq req, Object... queryObjs){
    ...
    @Operation(summary = QUERY_ACTION)
    @Override
    public TenantAppInfo findOne(QueryTenantAppReq req, Object... queryObjs){
    ...
    */
    ...
    /**
    * 清除[TenantAppService.CACHE_NAME]缓存中的所有缓存
    *
    */
    @Override
