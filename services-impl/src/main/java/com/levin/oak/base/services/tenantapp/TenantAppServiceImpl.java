 ...
 * 租户应用-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月23日 下午11:55:35, 代码生成哈希校验码：[767bdec6b5e63701980339404d3affe2]，请不要修改和删除此行内容。
 *
 */
...
public class TenantAppServiceImpl extends BaseService implements TenantAppService {
    ...
    @Override
    //@CacheEvict(condition = "#isNotEmpty(#req.id) && #result", key = E_TenantApp.CACHE_KEY_PREFIX + "#req.id")
    @Transactional
