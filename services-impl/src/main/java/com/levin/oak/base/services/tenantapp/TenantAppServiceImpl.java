 ...
 * 租户应用-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月15日 下午6:26:10, 代码生成哈希校验码：[c276955fa66ec46b1b58ae5efef5aaa8]，请不要修改和删除此行内容。
 */
...
public class TenantAppServiceImpl extends BaseService implements TenantAppService {
    ...
    @Override
    // @CacheEvict(condition = "#isNotEmpty(#req.id)", key = E_TenantApp.CACHE_KEY_PREFIX +
    // "#req.id")
    @Transactional(rollbackFor = RuntimeException.class)
    ...
    // E_TenantApp.CACHE_KEY_PREFIX + "#id")
    ...
    // E_TenantApp.CACHE_KEY_PREFIX + "#req.id")
