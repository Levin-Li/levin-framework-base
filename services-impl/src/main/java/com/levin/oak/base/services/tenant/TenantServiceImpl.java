 ...
 * 平台租户-服务实现
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月28日 下午3:56:01, 代码生成哈希校验码：[a720bcbbefc6ffaaa9aef60963aa8d4a]，请不要修改和删除此行内容。
 *
 */

@Service(TenantService.SERVICE_BEAN_NAME)

@ConditionalOnProperty(name = TenantService.SERVICE_BEAN_NAME, havingValue = "true", matchIfMissing = true)
@Slf4j
...
public class TenantServiceImpl extends BaseService implements TenantService {
    ...
    */
    ...
    @Transactional
    public boolean update(UpdateTenantReq req, Object... queryObjs) {
    ...
    @Override
    public PagingData<TenantInfo> query(QueryTenantReq req, Paging paging, Object... queryObjs) {
        return simpleDao.findPagingDataByQueryObj(req, paging, queryObjs);
    }

    @Operation(summary = QUERY_ACTION + "-指定列", description = "通常用于字段过多的情况，提升性能")
    public PagingData<TenantInfo> selectQuery(QueryTenantReq req, Paging paging, String... columnNames){
        return simpleDao.forSelect(TenantInfo.class, req, paging).select(columnNames).findPaging(null, paging);
    }
