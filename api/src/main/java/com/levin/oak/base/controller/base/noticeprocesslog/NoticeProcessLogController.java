...
public abstract class NoticeProcessLogController extends BaseController{
    ...
    public ApiResp<PagingData<NoticeProcessLogInfo>> list(@Form @Valid QueryNoticeProcessLogReq req, SimplePaging paging) {
        ...
        return ApiResp.ok(checkResponse(QUERY_LIST_ACTION, noticeProcessLogService.query(req,paging)));
    }
     ...
     public ApiResp<PagingData<StatNoticeProcessLogReq.Result>> stat(@Valid StatNoticeProcessLogReq req, SimplePaging paging) {

         req = checkRequest(STAT_ACTION, req);

         return ApiResp.ok(checkResponse(STAT_ACTION, noticeProcessLogService.stat(req,paging)));
     }
    ...
    public ApiResp<NoticeProcessLogInfo> retrieve(@NotNull @Valid NoticeProcessLogIdReq req, @PathVariable(required = false) String id) {
         ...
         NoticeProcessLogInfo info = noticeProcessLogService.findById(req);
    ...
    public ApiResp<Boolean> update(@RequestBody @Valid UpdateNoticeProcessLogReq req, @PathVariable(required = false) String id) {
        ...
        return ApiResp.ok(assertTrue(noticeProcessLogService.update(req), UPDATE_ACTION + BIZ_NAME + "失败"));
    }
    ...
    public ApiResp<Boolean> delete(@Valid NoticeProcessLogIdReq req, @PathVariable(required = false) String id) {
        ...
        return ApiResp.ok(assertTrue(noticeProcessLogService.delete(req), DELETE_ACTION + BIZ_NAME + "失败"));
    }
    ...
    public ApiResp<Integer> batchUpdate(@RequestBody @Valid List<UpdateNoticeProcessLogReq> reqList) {
        ...
        return ApiResp.ok(assertTrue(noticeProcessLogService.batchUpdate(reqList), BATCH_UPDATE_ACTION + BIZ_NAME + "失败"));
    }
    ...
    public ApiResp<Integer> batchDelete(@NotNull @Valid DeleteNoticeProcessLogReq req) {
        ...
        return ApiResp.ok(assertTrue(noticeProcessLogService.batchDelete(req), BATCH_DELETE_ACTION + BIZ_NAME + "失败"));
    }
