package com.levin.oak.base.controller.base.appclient;
...
* 应用接入控制器
*
* @author Auto gen by simple-dao-codegen, @time: 2024年3月11日 下午1:45:03, 代码生成哈希校验码：[8a29cbd09c0726a1e7f44bd538397322]，请不要修改和删除此行内容。
*
*/
...
public abstract class AppClientController extends BaseController{
    ...
    public ApiResp<PagingData<AppClientInfo>> list(@Form @Valid QueryAppClientReq req, SimplePaging paging) {
        ...
        return ApiResp.ok(checkResponse(QUERY_LIST_ACTION, getAppClientService().query(req, paging)));
    }
    ...
    public ApiResp<String> create(@RequestBody @Valid CreateAppClientReq req) {
        ...
        return ApiResp.ok(getAppClientService().create(req));
    }
    ...
    public ApiResp<AppClientInfo> retrieve(@NotNull @Valid AppClientIdReq req, @PathVariable(required = false) String id) {
         ...
         AppClientInfo info = getAppClientService().findById(req);
    ...
    public ApiResp<Boolean> update(@RequestBody @Valid UpdateAppClientReq req, @PathVariable(required = false) String id) {
        ...
        return ApiResp.ok(assertTrue(getAppClientService().update(req), UPDATE_ACTION + BIZ_NAME + "失败"));
    }
    ...
    public ApiResp<Boolean> delete(@Valid AppClientIdReq req, @PathVariable(required = false) String id) {
        ...
        return ApiResp.ok(assertTrue(getAppClientService().delete(req), DELETE_ACTION + BIZ_NAME + "失败"));
    }
    ...
    public ApiResp<List<String>> batchCreate(@RequestBody @Valid List<CreateAppClientReq> reqList) {
        ...
        return ApiResp.ok(getAppClientService().batchCreate(reqList));
    }
    ...
    public ApiResp<Integer> batchUpdate(@RequestBody @Valid List<UpdateAppClientReq> reqList) {
        ...
        return ApiResp.ok(assertTrue(getAppClientService().batchUpdate(reqList), BATCH_UPDATE_ACTION + BIZ_NAME + "失败"));
    }
    ...
    public ApiResp<Integer> batchDelete(@NotNull @Valid DeleteAppClientReq req) {
        ...
        return ApiResp.ok(assertTrue(getAppClientService().batchDelete(req), BATCH_DELETE_ACTION + BIZ_NAME + "失败"));
    }
