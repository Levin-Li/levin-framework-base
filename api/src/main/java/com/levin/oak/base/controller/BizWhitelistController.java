...
import com.levin.oak.base.controller.base.whitelist.*;
...
* 白名单业务控制器
*
* @author Auto gen by simple-dao-codegen, @time: 2024年3月2日 下午8:42:29, 代码生成哈希校验码：[5af582d0234944762f34cfc112212b06]，请不要修改和删除此行内容。
*
*/

//生成的控制器
@RestController(PLUGIN_PREFIX + "BizWhitelistController")
@RequestMapping(API_PATH + "Whitelist") //whitelist

@ConditionalOnProperty(prefix = PLUGIN_PREFIX, name = "BizWhitelistController", havingValue = "true", matchIfMissing = true)
...
@Slf4j
public class BizWhitelistController extends WhitelistController{
    ...
    * @return  ApiResp<StatWhitelistReq.Result>
    */
    @GetMapping("stat") //默认开放
    @Operation(summary = STAT_ACTION, description = STAT_ACTION + " " + BIZ_NAME)
    public ApiResp<StatWhitelistReq.Result> stat(@Valid StatWhitelistReq req, SimplePaging paging) {

        req = checkRequest(STAT_ACTION, req);

        return ApiResp.ok(checkResponse(STAT_ACTION, bizWhitelistService.stat(req, paging)));
    }
