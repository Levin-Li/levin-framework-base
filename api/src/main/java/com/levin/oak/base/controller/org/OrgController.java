 ...
 * 机构控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月1日 下午3:17:43, 代码生成哈希校验码：[a0cfa5195b5af1b142b6b381028b5565]，请不要修改和删除此行内容。
 *
 */
public class OrgController extends BaseController{
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<OrgInfo>> queryList(@Form @Valid QueryOrgReq req, SimplePaging paging) {
