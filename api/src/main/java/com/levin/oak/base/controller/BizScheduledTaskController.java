...
import com.levin.oak.base.controller.base.scheduledtask.*;
...
* 调度任务业务控制器
*
* @author Auto gen by simple-dao-codegen, @time: 2023年12月12日 下午11:15:25, 代码生成哈希校验码：[53dab0cd75e2b9ce7e357b3d8a8a00d2]，请不要修改和删除此行内容。
*
*/

//生成的控制器
@RestController(PLUGIN_PREFIX + "BizScheduledTaskController")
@RequestMapping(API_PATH + "ScheduledTask") //scheduledtask

@ConditionalOnProperty(prefix = PLUGIN_PREFIX, name = "BizScheduledTaskController", havingValue = "true", matchIfMissing = true)
...
public class BizScheduledTaskController extends ScheduledTaskController{
    ...
    * @return  ApiResp<StatScheduledTaskReq.Result>
    */
    @GetMapping("/stat") //默认开放
    @Operation(summary = STAT_ACTION, description = STAT_ACTION + " " + BIZ_NAME)
    public ApiResp<StatScheduledTaskReq.Result> stat(@Valid StatScheduledTaskReq req, SimplePaging paging) {
