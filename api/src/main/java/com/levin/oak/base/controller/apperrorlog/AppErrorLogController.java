 ...
 * 应用错误日志控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月1日 下午3:17:41, 代码生成哈希校验码：[d5df5aa84013a382999fb46f69e92908]，请不要修改和删除此行内容。
 *
 */
public class AppErrorLogController extends BaseController{
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<AppErrorLogInfo>> queryList(@Form @Valid QueryAppErrorLogReq req, SimplePaging paging) {
