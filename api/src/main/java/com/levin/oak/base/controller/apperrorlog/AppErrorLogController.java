 ...
 * 应用错误日志控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月18日 上午12:26:20, 代码生成哈希校验码：[61b0257fb08b2d2884498ecd4f79dd58]，请不要修改和删除此行内容。
 */
public class AppErrorLogController extends BaseController {
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<AppErrorLogInfo>> list(
