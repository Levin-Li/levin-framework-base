...
import com.levin.oak.base.controller.base.apperrorlog.*;
...
* 应用错误日志业务控制器
*
* @author Auto gen by simple-dao-codegen, @time: 2023年12月12日 下午10:13:36, 代码生成哈希校验码：[8f28dbbf47c3d9c5ca7a8f89428a55b6]，请不要修改和删除此行内容。
*
*/

//生成的控制器
@RestController(PLUGIN_PREFIX + "BizAppErrorLogController")
@RequestMapping(API_PATH + "AppErrorLog") //apperrorlog

@ConditionalOnProperty(prefix = PLUGIN_PREFIX, name = "BizAppErrorLogController", havingValue = "true", matchIfMissing = true)

//默认需要权限访问
@ResAuthorize(domain = ID, type = BIZ_TYPE_NAME + "-" + E_AppErrorLog.BIZ_NAME)
...
public class BizAppErrorLogController extends AppErrorLogController{
    ...
    * @return  ApiResp<StatAppErrorLogReq.Result>
    */
    @GetMapping("/stat") //默认开放
    @Operation(summary = STAT_ACTION, description = STAT_ACTION + " " + BIZ_NAME)
    public ApiResp<StatAppErrorLogReq.Result> stat(@Valid StatAppErrorLogReq req, SimplePaging paging) {
