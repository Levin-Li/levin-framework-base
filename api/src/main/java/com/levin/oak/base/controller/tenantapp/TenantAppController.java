 ...
 * 租户应用控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月1日 下午3:17:40, 代码生成哈希校验码：[ca1c2ec9fd4478cd305e6f3f16be3309]，请不要修改和删除此行内容。
 *
 */
public class TenantAppController extends BaseController{
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<TenantAppInfo>> queryList(@Form @Valid QueryTenantAppReq req, SimplePaging paging) {
