 ...
 * 应用接入控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月18日 上午12:26:19, 代码生成哈希校验码：[f9bbab550297773d76db5fcd436ea44f]，请不要修改和删除此行内容。
 */
public class AppClientController extends BaseController {
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<AppClientInfo>> list(
