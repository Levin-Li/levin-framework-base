...
import com.levin.oak.base.controller.base.dynamicverifycodecfg.*;
...
* 动态验证码配置业务控制器
*
* @author Auto gen by simple-dao-codegen, @time: 2024年3月9日 下午10:46:13, 代码生成哈希校验码：[f75ec3d4a7d1960f43e3d165b864319b]，请不要修改和删除此行内容。
*
*/

//生成的控制器
@RestController(PLUGIN_PREFIX + "BizDynamicVerifyCodeCfgController")
@RequestMapping(API_PATH + "DynamicVerifyCodeCfg") //dynamicverifycodecfg

@ConditionalOnProperty(prefix = PLUGIN_PREFIX, name = "BizDynamicVerifyCodeCfgController", havingValue = "true", matchIfMissing = true)
...
@Slf4j
public class BizDynamicVerifyCodeCfgController extends DynamicVerifyCodeCfgController{
    ...
    * @return  ApiResp<StatDynamicVerifyCodeCfgReq.Result>
    */
    @GetMapping("stat") //默认开放
    @Operation(summary = STAT_ACTION, description = STAT_ACTION + " " + BIZ_NAME)
    public ApiResp<StatDynamicVerifyCodeCfgReq.Result> stat(@Valid StatDynamicVerifyCodeCfgReq req, SimplePaging paging) {

        req = checkRequest(STAT_ACTION, req);

        return ApiResp.ok(checkResponse(STAT_ACTION, bizDynamicVerifyCodeCfgService.stat(req, paging)));
    }
