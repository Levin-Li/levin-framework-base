...
public class SimpleFormController extends BaseController{
    ...
    */
    ...
    public ApiResp<Void> delete(@PathVariable @NotNull Long id) {
        return simpleFormService.delete(new DeleteSimpleFormReq().setId(id)) > 0
    ...
    public ApiResp<Void> batchDelete(@NotNull DeleteSimpleFormReq req) {
        //new DeleteSimpleFormReq().setIdList(idList)
        return simpleFormService.delete(req) > 0 ? ApiResp.ok() : ApiResp.error(DELETE_ACTION + BIZ_NAME + "失败");
    }  
