 ...
 * 简单表单控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月1日 下午3:17:45, 代码生成哈希校验码：[393b339748ff4d436ba3b049564fb8df]，请不要修改和删除此行内容。
 *
 */
public class SimpleFormController extends BaseController{
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<SimpleFormInfo>> queryList(@Form @Valid QuerySimpleFormReq req, SimplePaging paging) {
