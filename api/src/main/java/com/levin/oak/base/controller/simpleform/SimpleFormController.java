 ...
 * 简单表单控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月18日 上午12:26:21, 代码生成哈希校验码：[439b0f07a2e9d5623d6fd55b229132f6]，请不要修改和删除此行内容。
 */
public class SimpleFormController extends BaseController {
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<SimpleFormInfo>> list(
