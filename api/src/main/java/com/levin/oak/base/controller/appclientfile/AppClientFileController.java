 ...
 * 客户端文件控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月1日 下午3:17:41, 代码生成哈希校验码：[0fe276535ea6fac886ce5a2ea97a304f]，请不要修改和删除此行内容。
 *
 */
public class AppClientFileController extends BaseController{
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<AppClientFileInfo>> queryList(@Form @Valid QueryAppClientFileReq req, SimplePaging paging) {
