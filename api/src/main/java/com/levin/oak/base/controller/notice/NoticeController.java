 ...
 * 通知控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月1日 下午3:17:41, 代码生成哈希校验码：[f6fb9df6a451cf95fa7e90e97bdd856a]，请不要修改和删除此行内容。
 *
 */
public class NoticeController extends BaseController{
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<NoticeInfo>> queryList(@Form @Valid QueryNoticeReq req, SimplePaging paging) {
