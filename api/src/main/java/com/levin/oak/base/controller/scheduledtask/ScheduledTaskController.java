 ...
 * 调度任务控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月18日 上午12:26:20, 代码生成哈希校验码：[9813e2ce7afe31bbd378bba833a7d2c3]，请不要修改和删除此行内容。
 */
public class ScheduledTaskController extends BaseController {
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<ScheduledTaskInfo>> list(
