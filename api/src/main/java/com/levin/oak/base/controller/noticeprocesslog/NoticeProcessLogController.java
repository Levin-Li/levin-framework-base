 ...
 * 通知处理日志控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月1日 下午3:17:43, 代码生成哈希校验码：[141b7e0f0d6351923a020f15f2fa66f0]，请不要修改和删除此行内容。
 *
 */
public class NoticeProcessLogController extends BaseController{
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<NoticeProcessLogInfo>> queryList(@Form @Valid QueryNoticeProcessLogReq req, SimplePaging paging) {
