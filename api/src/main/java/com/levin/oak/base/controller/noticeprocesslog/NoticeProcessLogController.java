 ...
 * 通知处理日志控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月18日 上午12:26:20, 代码生成哈希校验码：[0d775de85e572db6e3216ac2994dbb11]，请不要修改和删除此行内容。
 */
public class NoticeProcessLogController extends BaseController {
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<NoticeProcessLogInfo>> list(
