...
* 国际化资源控制器
*
* @author Auto gen by simple-dao-codegen, @time: 2023年12月7日 下午9:11:57, 代码生成哈希校验码：[e8ce205568501bdabb148c0a26c8fa92]，请不要修改和删除此行内容。
*
*/
...
//默认需要权限访问，默认从父类继承
@ResAuthorize(domain = ID, type = SYS_TYPE_NAME + "-" + E_I18nRes.BIZ_NAME)
