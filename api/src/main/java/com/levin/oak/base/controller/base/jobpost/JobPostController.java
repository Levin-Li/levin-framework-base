...
* 工作岗位控制器
*
* @author Auto gen by simple-dao-codegen, @time: 2023年12月7日 上午11:03:11, 代码生成哈希校验码：[bdffae4d847e21f5702eff6e410df3f5]，请不要修改和删除此行内容。
*
*/
...
public abstract class JobPostController extends BaseController{
    ...
    public ApiResp<JobPostInfo> retrieve(@NotNull @Valid JobPostIdReq req, @PathVariable(required = false) String id) {
         ...
         JobPostInfo info = jobPostService.findById(req);
