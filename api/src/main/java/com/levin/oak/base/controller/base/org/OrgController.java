...
* 机构控制器
*
* @author Auto gen by simple-dao-codegen, @time: 2023年12月7日 下午9:11:57, 代码生成哈希校验码：[ae5f0de747e65d9c6267ca4f92893e98]，请不要修改和删除此行内容。
*
*/
...
//默认需要权限访问，默认从父类继承
@ResAuthorize(domain = ID, type = SYS_TYPE_NAME + "-" + E_Org.BIZ_NAME)
