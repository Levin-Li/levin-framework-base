 ...
 * 国际化资源控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月1日 下午3:17:44, 代码生成哈希校验码：[6246777263bb4f166b2a6edb1460da15]，请不要修改和删除此行内容。
 *
 */
public class I18nResController extends BaseController{
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<I18nResInfo>> queryList(@Form @Valid QueryI18nResReq req, SimplePaging paging) {
