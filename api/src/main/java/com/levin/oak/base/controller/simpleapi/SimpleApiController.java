 ...
 * 简单动态接口控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月18日 上午12:26:19, 代码生成哈希校验码：[c35988970e85f06cf710cb6529708b06]，请不要修改和删除此行内容。
 */
public class SimpleApiController extends BaseController {
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<SimpleApiInfo>> list(
