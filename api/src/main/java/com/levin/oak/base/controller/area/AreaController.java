 ...
 * 区域控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月1日 下午3:17:44, 代码生成哈希校验码：[4afefcaef7f854b0258ae0dcead0ad7d]，请不要修改和删除此行内容。
 *
 */
public class AreaController extends BaseController{
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<AreaInfo>> queryList(@Form @Valid QueryAreaReq req, SimplePaging paging) {
