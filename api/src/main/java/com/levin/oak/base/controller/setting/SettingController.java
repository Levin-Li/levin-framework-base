...
public class SettingController extends BaseController{
    ...
    */
    ...
    public ApiResp<SettingInfo> retrieve(@NotNull QuerySettingByIdReq req) {
    ...
    */
    ...
    public ApiResp<SettingInfo> retrieve(@PathVariable @NotNull Long id) {
         ...
         return getSelfProxy(getClass()).retrieve(new QuerySettingByIdReq().setId(id));
    ...
    public ApiResp<Integer> delete(@PathVariable @NotNull Long id) {
        return getSelfProxy(getClass()).batchDelete(new DeleteSettingReq().setId(id));
    }
