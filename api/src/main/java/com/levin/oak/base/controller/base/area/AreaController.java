...
* 区域控制器
*
* @author Auto gen by simple-dao-codegen, @time: 2023年12月7日 下午9:11:57, 代码生成哈希校验码：[095fd5fac5273433ff0081ba999862cb]，请不要修改和删除此行内容。
*
*/
...
//默认需要权限访问，默认从父类继承
@ResAuthorize(domain = ID, type = PLATFORM_TYPE_NAME + "-" + E_Area.BIZ_NAME)
