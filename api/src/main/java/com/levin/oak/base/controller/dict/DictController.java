 ...
 * 字典控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月1日 下午3:17:40, 代码生成哈希校验码：[6da7bffc11f254413468a78a2231424c]，请不要修改和删除此行内容。
 *
 */
public class DictController extends BaseController{
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<DictInfo>> queryList(@Form @Valid QueryDictReq req, SimplePaging paging) {
