 ...
 * 调度日志控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月1日 下午3:17:39, 代码生成哈希校验码：[7885d8e0fbbd210afb82e505ca56464a]，请不要修改和删除此行内容。
 *
 */
public class ScheduledLogController extends BaseController{
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<ScheduledLogInfo>> queryList(@Form @Valid QueryScheduledLogReq req, SimplePaging paging) {
