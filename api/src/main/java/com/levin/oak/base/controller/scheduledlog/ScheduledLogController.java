 ...
 * 调度日志控制器
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月18日 上午12:26:19, 代码生成哈希校验码：[42b7e436a6d55e1460c4be58ebc21da4]，请不要修改和删除此行内容。
 */
public class ScheduledLogController extends BaseController {
    ...
    @CRUD.ListTable
    public ApiResp<PagingData<ScheduledLogInfo>> list(
