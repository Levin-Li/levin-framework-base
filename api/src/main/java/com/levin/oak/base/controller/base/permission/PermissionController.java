...
public abstract class PermissionController extends BaseController{
    ...
    public ApiResp<PagingData<PermissionInfo>> list(@Form @Valid QueryPermissionReq req, SimplePaging paging) {
        ...
        return ApiResp.ok(checkResponse(QUERY_LIST_ACTION, permissionService.query(req, paging)));
    }
    ...
    public ApiResp<String> create(@RequestBody @Valid CreatePermissionReq req) {
        ...
        return ApiResp.ok(permissionService.create(req));
    }
    ...
    public ApiResp<PermissionInfo> retrieve(@NotNull @Valid PermissionIdReq req, @PathVariable(required = false) String id) {
         ...
         PermissionInfo info = permissionService.findById(req);
    ...
    public ApiResp<Boolean> update(@RequestBody @Valid UpdatePermissionReq req, @PathVariable(required = false) String id) {
        ...
        return ApiResp.ok(assertTrue(permissionService.update(req), UPDATE_ACTION + BIZ_NAME + "失败"));
    }
    ...
    public ApiResp<Boolean> delete(@Valid PermissionIdReq req, @PathVariable(required = false) String id) {
        ...
        return ApiResp.ok(assertTrue(permissionService.delete(req), DELETE_ACTION + BIZ_NAME + "失败"));
    }
    ...
    public ApiResp<List<String>> batchCreate(@RequestBody @Valid List<CreatePermissionReq> reqList) {
        ...
        return ApiResp.ok(permissionService.batchCreate(reqList));
    }
    ...
    public ApiResp<Integer> batchUpdate(@RequestBody @Valid List<UpdatePermissionReq> reqList) {
        ...
        return ApiResp.ok(assertTrue(permissionService.batchUpdate(reqList), BATCH_UPDATE_ACTION + BIZ_NAME + "失败"));
    }
    ...
    public ApiResp<Integer> batchDelete(@NotNull @Valid DeletePermissionReq req) {
        ...
        return ApiResp.ok(assertTrue(permissionService.batchDelete(req), BATCH_DELETE_ACTION + BIZ_NAME + "失败"));
    }
