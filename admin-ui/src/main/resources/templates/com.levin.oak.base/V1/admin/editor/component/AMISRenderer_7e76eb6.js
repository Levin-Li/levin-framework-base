amis.define('component/AMISRenderer.tsx', function(require, exports, module, define) {

  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.schema2component = void 0;
  ...
  function schema2component(schema, transform, session) {
      ...
      var SchemaRenderer = /** @class */ (function (_super) {
          ...
          SchemaRenderer.prototype.getEnv = function () {
              ...
              var rootEnv = (0, mobx_state_tree_1.getEnv)(store);
              var normalizeLink = function (to, preserveHash) {
                  ...
                  to = (0, amis_1.filter)(to.replace(/\$\$/g, qs_1.default.stringify(currentQuery)), currentQuery);
                  if (to && to[0] === '#') {
              ...
              return (this.env = tslib_1.__assign(tslib_1.__assign({}, rootEnv), { session: session, isCurrentUrl: isCurrentUrl, updateLocation: props.updateLocation ||
          ...
          SchemaRenderer.prototype.render = function () {
              ...
              body = (0, amis_1.render)(finalSchema, tslib_1.__assign(tslib_1.__assign({ location: location, data: amis_1.utils.createObject(tslib_1.__assign(tslib_1.__assign({}, match.params), { amisStore: store, pathname: location.pathname, params: match.params })) }, rest), { fetcher: store.fetcher, notify: store.notify, alert: store.alert, copy: store.copy, propsTransform: transform }), this.getEnv());
          ...
          SchemaRenderer = tslib_1.__decorate([
              (0, mobx_react_1.inject)('store'),
              mobx_react_1.observer
          ], SchemaRenderer);
          return SchemaRenderer;
      }(react_1.default.Component));
      return (0, react_router_1.withRouter)(SchemaRenderer);
  }
