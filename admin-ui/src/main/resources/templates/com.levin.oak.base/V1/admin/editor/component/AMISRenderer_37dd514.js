  ...
  function schema2component(schema, transform, session) {
      ...
      var SchemaRenderer = /** @class */ (function (_super) {
          ...
          SchemaRenderer.prototype.render = function () {
              ...
              body = (0, amis_1.render)(finalSchema, tslib_1.__assign(tslib_1.__assign({ location: location, data: amis_1.utils.createObject(tslib_1.__assign(tslib_1.__assign({}, match.params), { amisStore: store, pathname: location.pathname, params: match.params })) }, rest), { propsTransform: transform }), this.getEnv());
