 ...
 * 统计通知处理日志
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月17日 上午2:26:21, 代码生成哈希校验码：[3e304d338c661e0fde83d8e366b4b805]，请不要修改和删除此行内容。
 */
...
public class StatNoticeProcessLogReq extends QueryNoticeProcessLogReq {
    ...
    public static class Result implements Serializable {
        ...
        // E_NoticeProcessLog.createDate + ",'%Y-%m-%d')", orderBy = @OrderBy(type =
        // OrderBy.Type.Asc))
        // String createDate;
        ...
        // @Count(fieldCases = {@Case(column = E_NoticeProcessLog.status, whenOptions =
