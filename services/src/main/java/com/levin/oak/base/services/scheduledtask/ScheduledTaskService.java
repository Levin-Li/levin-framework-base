 ...
 * 调度任务-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年8月13日 下午4:53:22, 代码生成哈希校验码：[7fb5ba08887c109210912932dafee9d4]，请不要修改和删除此行内容。
 */
...
public interface ScheduledTaskService {
    ...
    boolean update(@NotNull UpdateScheduledTaskReq req);
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int update(@NotNull SimpleUpdateScheduledTaskReq setReq, QueryScheduledTaskReq whereReq);
    ...
    PagingData<SimpleScheduledTaskInfo> simpleQuery(
            @NotNull QueryScheduledTaskReq req, Paging paging);
    ...
    PagingData<StatScheduledTaskReq.Result> stat(@NotNull StatScheduledTaskReq req, Paging paging);
     ...
     */
    @Operation(summary = STAT_ACTION)
    int count(@NotNull QueryScheduledTaskReq req);
