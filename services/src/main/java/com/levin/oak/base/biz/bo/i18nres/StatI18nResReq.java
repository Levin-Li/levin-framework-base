package com.levin.oak.base.biz.bo.i18nres;
 ...
 * 统计国际化资源
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月7日 上午11:03:11, 代码生成哈希校验码：[b74c337598dff6a96814f7f95e9e6148]，请不要修改和删除此行内容。
 *
 */
...
@TargetOption(entityClass = I18nRes.class, alias = E_I18nRes.ALIAS,
    ...
    resultClass = StatI18nResReq.Result.class
)
public class StatI18nResReq extends QueryI18nResReq{
    ...
    public static class Result
        ...
        //@GroupBy(condition = "#isGroupByDate", value = "date_format(" + E_I18nRes.createDate + ",'%Y-%m-%d')", orderBy = @OrderBy(type = OrderBy.Type.Asc))
        //String createDate;
        ...
        //@Count(fieldCases = {@Case(column = E_I18nRes.status, whenOptions = {@Case.When(whenExpr = "OFF", thenExpr = "1")}, elseExpr = "NULL")})
        //Integer caseCnt;
