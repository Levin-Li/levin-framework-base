 ...
 * 统计简单动态接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月17日 上午2:26:19, 代码生成哈希校验码：[5ab0fd74ed181050c72cfc0b4ee0b7fa]，请不要修改和删除此行内容。
 */
...
public class StatSimpleApiReq extends QuerySimpleApiReq {
    ...
    public static class Result implements Serializable {
        ...
        // @GroupBy(condition = "#isGroupByDate", value = "date_format(" + E_SimpleApi.createDate +
        ...
        // @Count(fieldCases = {@Case(column = E_SimpleApi.status, whenOptions =
