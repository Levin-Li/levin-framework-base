...
@ConditionalOnProperty(value = PLUGIN_PREFIX + "AccessLogService", havingValue = "false", matchIfMissing = true)
@Slf4j
//@Validated
...
public class AccessLogServiceImpl implements AccessLogService {
    ...
    @Operation(tags = {BIZ_NAME}, summary = VIEW_DETAIL_ACTION)
    @Override
    @Cacheable(condition = "#req.getCacheId() != null", unless = "#result == null ", key = E_AccessLog.CACHE_KEY_PREFIX + "#req.getCacheId()")
    public AccessLogInfo findById(QueryAccessLogByIdReq req) {
