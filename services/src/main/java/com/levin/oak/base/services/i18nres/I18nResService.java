 ...
 * 国际化资源-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:08, 代码生成哈希校验码：[cb74f4bb648a506c1b62426acf0f770d]，请不要修改和删除此行内容。
 *
 */
...
public interface I18nResService {
    ...
    */
    ...
    boolean update(@NotNull UpdateI18nResReq req, Object... queryObjs);
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateI18nResReq setReq, QueryI18nResReq whereReq, Object... queryObjs);
    ...
    PagingData<I18nResInfo> query(@NotNull QueryI18nResReq req, Paging paging, Object... queryObjs);
    ...
    PagingData<I18nResInfo> selectQuery(@NotNull QueryI18nResReq req, Paging paging, String... selectColumnNames);
    ...
    */
    @Operation(summary = QUERY_ACTION + "-指定列", description = "通常用于字段过多的情况，提升性能")
    default PagingData<I18nResInfo> selectQuery(@NotNull QueryI18nResReq req, Paging paging, PFunction<I18nRes,?>... selectColumns){
    ...
    int count(@NotNull QueryI18nResReq req, Object... queryObjs);
    ...
    */
     ...
     */
    @Operation(summary = QUERY_ACTION)
    I18nResInfo findOne(@NotNull QueryI18nResReq req, Object... queryObjs);
