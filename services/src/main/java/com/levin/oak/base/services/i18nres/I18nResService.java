 ...
 * 国际化资源-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月28日 下午3:56:02, 代码生成哈希校验码：[71bc8e64dd98eadca29be57119ea0298]，请不要修改和删除此行内容。
 *
 */
...
public interface I18nResService {
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateI18nResReq setReq, QueryI18nResReq whereReq);
    ...
    PagingData<I18nResInfo> selectQuery(@NotNull QueryI18nResReq req, Paging paging, String... columnNames);
