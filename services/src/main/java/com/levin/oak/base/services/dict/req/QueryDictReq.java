 ...
 * 查询字典
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月25日 下午12:47:02, 代码生成哈希校验码：[8032d1ae5daa2aa3171728cb871f2364]，请不要修改和删除此行内容。
 *
 */
...
public class QueryDictReq extends MultiTenantOrgReq<QueryDictReq> {
