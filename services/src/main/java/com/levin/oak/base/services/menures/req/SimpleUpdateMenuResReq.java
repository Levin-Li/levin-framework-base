 ...
 * 代码生成哈希校验码：[fdc7dd67bc798d10d0c62b9bd4aa4e5a], 请不要修改和删除此行内容。
 */
...
public class SimpleUpdateMenuResReq extends MultiTenantReq {
    ...
    public SimpleUpdateMenuResReq(String id) {
        this.id = id;
    }

    public SimpleUpdateMenuResReq updateIdWhenNotBlank(String id){
        if(isNotBlank(id)){
        this.id = id;
        }
        return this;
