package com.levin.oak.base.biz.bo.permission;
 ...
 * 统计权限清单
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年1月27日 上午11:48:06, 代码生成哈希校验码：[166042e4b62c7c1bfbf17c33f8f4ae48]，请不要修改和删除此行内容。
 *
 */
...
@TargetOption(entityClass = Permission.class, alias = E_Permission.ALIAS,
    ...
    resultClass = StatPermissionReq.Result.class
)
public class StatPermissionReq extends QueryPermissionReq{
    ...
    public static class Result
        ...
        //@GroupBy(condition = "#isGroupByDate", value = "date_format(" + E_Permission.createDate + ",'%Y-%m-%d')", orderBy = @OrderBy(type = OrderBy.Type.Asc))
        //String createDate;
        ...
        //@Count(fieldCases = {@Case(column = E_Permission.status, whenOptions = {@Case.When(whenExpr = "OFF", thenExpr = "1")}, elseExpr = "NULL")})
        //Integer caseCnt;
