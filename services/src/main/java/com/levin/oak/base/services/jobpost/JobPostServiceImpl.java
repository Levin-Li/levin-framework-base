...
@ConditionalOnProperty(value = PLUGIN_PREFIX + "JobPostService", havingValue = "false", matchIfMissing = true)
@Slf4j
//@Validated
...
public class JobPostServiceImpl extends BaseService implements JobPostService {
    ...
    public JobPostInfo findById(Long id) {
        ...
        return simpleDao.findOneByQueryObj(new QueryJobPostReq().setId(id));
    }
    ...
    public int delete(DeleteJobPostReq req) {
