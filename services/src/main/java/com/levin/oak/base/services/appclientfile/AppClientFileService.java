...
public interface AppClientFileService {
    ...
    Long create(@NotNull CreateAppClientFileReq req);
    ...
    List<Long> batchCreate(@NotNull List<CreateAppClientFileReq> reqList);
    ...
    AppClientFileInfo findById(@NotNull Long id);
