 ...
 * 客户端文件-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:07, 代码生成哈希校验码：[e0d3950e9204cc488ee8d486159f7f63]，请不要修改和删除此行内容。
 *
 */
...
public interface AppClientFileService {
    ...
    */
    ...
    String create(@NotNull CreateAppClientFileReq req);
    ...
    List<String> batchCreate(@NotNull List<CreateAppClientFileReq> reqList);
    ...
    boolean update(@NotNull UpdateAppClientFileReq req, Object... queryObjs);
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateAppClientFileReq setReq, QueryAppClientFileReq whereReq, Object... queryObjs);
    ...
    int batchUpdate(@NotNull List<UpdateAppClientFileReq> reqList);
    ...
    boolean delete(@NotNull AppClientFileIdReq req);
    ...
    int batchDelete(@NotNull DeleteAppClientFileReq req);
    ...
    PagingData<AppClientFileInfo> selectQuery(@NotNull QueryAppClientFileReq req, Paging paging, String... selectColumnNames);
    ...
    */
    @Operation(summary = QUERY_ACTION + "-指定列", description = "通常用于字段过多的情况，提升性能")
    default PagingData<AppClientFileInfo> selectQuery(@NotNull QueryAppClientFileReq req, Paging paging, PFunction<AppClientFile,?>... selectColumns){
    ...
    int count(@NotNull QueryAppClientFileReq req, Object... queryObjs);
    ...
    AppClientFileInfo findById(@NotNull String id);
    ...
    */
    @Operation(summary = VIEW_DETAIL_ACTION)
    AppClientFileInfo findById(@NotNull AppClientFileIdReq req);
     ...
     */
    @Operation(summary = QUERY_ACTION)
    AppClientFileInfo findOne(@NotNull QueryAppClientFileReq req, Object... queryObjs);
     ...
     */
    @Operation(summary = QUERY_ACTION)
    AppClientFileInfo findUnique(QueryAppClientFileReq req);
