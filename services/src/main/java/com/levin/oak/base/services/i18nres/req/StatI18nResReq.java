 ...
 * 统计国际化资源
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年10月28日 下午12:14:21, 代码生成哈希校验码：[df151726efdffd3326141ffbc4ef1ba1]，请不要修改和删除此行内容。
 */
...
public class StatI18nResReq extends MultiTenantOrgReq {
    ...
    public static class Result implements Serializable {
        ...
        // @GroupBy(condition = "#isGroupByDate", value = "date_format(" + E_I18nRes.createDate +
        ...
        // @Count(fieldCases = {@Case(column = E_I18nRes.status, whenOptions = {@Case.When(whenExpr
