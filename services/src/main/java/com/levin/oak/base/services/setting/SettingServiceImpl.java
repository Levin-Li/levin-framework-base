...
@Slf4j
//@Validated
@Tag(name = E_Setting.BIZ_NAME, title = E_Setting.BIZ_NAME + MAINTAIN_ACTION)
@CacheConfig(cacheNames = {ModuleOption.ID + ModuleOption.CACHE_DELIM + E_Setting.SIMPLE_CLASS_NAME})
