 ...
 * 查询用户
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月28日 下午2:57:22, 代码生成哈希校验码：[a0526cd840d4e0252f7d0e8d48b10c94]，请不要修改和删除此行内容。
 *
 */
...
public class QueryUserReq extends MultiTenantOrgReq<QueryUserReq> {
