 ...
 * 代码生成哈希校验码：[91aea596ecde99d5d8a5f3030701d77e], 请不要修改和删除此行内容。
 */
...
public class SimpleUpdateScheduledTaskReq extends MultiTenantOrgReq {
    ...
    public SimpleUpdateScheduledTaskReq(String id) {
        this.id = id;
    }

    public SimpleUpdateScheduledTaskReq updateIdWhenNotBlank(String id){
        if(isNotBlank(id)){
        this.id = id;
        }
        return this;
