 ...
 * 平台租户-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月7日 上午11:03:10, 代码生成哈希校验码：[2e6811998d87190e53e7e858f35cb418]，请不要修改和删除此行内容。
 *
 */
...
public interface TenantService {
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int update(@NotNull SimpleUpdateTenantReq setReq, QueryTenantReq whereReq);
    ...
    PagingData<TenantInfo> selectQuery(@NotNull QueryTenantReq req, Paging paging, String... columnNames);
