 ...
 * 平台租户-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:07, 代码生成哈希校验码：[cfd79ec563f7d83130e52a5e0aa2b5a9]，请不要修改和删除此行内容。
 *
 */
...
public interface TenantService {
    ...
    String CACHE_NAME = ModuleOption.ID + CACHE_DELIM + E_Tenant.SIMPLE_CLASS_NAME;

    //缓存key前缀
    String CK_PREFIX = E_Tenant.CACHE_KEY_PREFIX;

    //缓存key前缀Spel表达式
    String CK_PREFIX_EXPR = E_Tenant.CACHE_KEY_PREFIX_EXPR;
    ...
    */
    ...
    boolean update(@NotNull UpdateTenantReq req, Object... queryObjs);
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateTenantReq setReq, QueryTenantReq whereReq, Object... queryObjs);
    ...
    PagingData<TenantInfo> selectQuery(@NotNull QueryTenantReq req, Paging paging, String... selectColumnNames);
    ...
    */
    @Operation(summary = QUERY_ACTION + "-指定列", description = "通常用于字段过多的情况，提升性能")
    default PagingData<TenantInfo> selectQuery(@NotNull QueryTenantReq req, Paging paging, PFunction<Tenant,?>... selectColumns){
    ...
    int count(@NotNull QueryTenantReq req, Object... queryObjs);
    ...
    */
     ...
     */
    @Operation(summary = QUERY_ACTION)
    TenantInfo findOne(@NotNull QueryTenantReq req, Object... queryObjs);
