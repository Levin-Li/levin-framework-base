 ...
 * 删除权限清单
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年1月27日 上午11:48:06, 代码生成哈希校验码：[23a2c7eee7247069956b509254f00d67]，请不要修改和删除此行内容。
 *
 */
...
public class DeletePermissionReq extends BaseReq {
    ...
    public DeletePermissionReq(String... idList) {
        this.idList = idList;
    }

    public DeletePermissionReq setIdList(String... idList) {
        this.idList = idList;
        return this;
    }
