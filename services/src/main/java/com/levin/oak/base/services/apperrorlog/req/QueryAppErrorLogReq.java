 ...
 * 查询应用错误日志
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月11日 下午5:00:19, 代码生成哈希校验码：[9d3347b746ae170e3a2424284b4e9ef1]，请不要修改和删除此行内容。
 *
 */
...
public class QueryAppErrorLogReq extends MultiTenantReq<QueryAppErrorLogReq> {
