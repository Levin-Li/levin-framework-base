 ...
 * 统计应用接入
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年10月28日 下午12:14:17, 代码生成哈希校验码：[8d25a44049c3cdc0047998157a0ad34b]，请不要修改和删除此行内容。
 */
...
public class StatAppClientReq extends MultiTenantOrgReq {
    ...
    public StatAppClientReq(String id) {
        this.id = id;
    }
    ...
    public static class Result implements Serializable {
        ...
        // @GroupBy(condition = "#isGroupByDate", value = "date_format(" + E_AppClient.createDate +
        ...
        // @Count(fieldCases = {@Case(column = E_AppClient.status, whenOptions =
