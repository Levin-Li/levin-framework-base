 ...
 * 统计用户
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月17日 上午2:26:21, 代码生成哈希校验码：[cb9ef9e97cba1cc1558d75f10e719ab8]，请不要修改和删除此行内容。
 */
...
public class StatUserReq extends QueryUserReq {
    ...
    public static class Result implements Serializable {
        ...
        // @GroupBy(condition = "#isGroupByDate", value = "date_format(" + E_User.createDate +
        ...
        // @Count(fieldCases = {@Case(column = E_User.status, whenOptions = {@Case.When(whenExpr =
