...
public interface SimpleApiService {
    ...
    Long create(@NotNull CreateSimpleApiReq req);
    ...
    List<Long> batchCreate(@NotNull List<CreateSimpleApiReq> reqList);
    ...
    SimpleApiInfo findById(@NotNull Long id);
    ...
    */
    ...
    int update(@NotNull UpdateSimpleApiReq req);
    ...
    int delete(@NotNull SimpleApiIdReq req);
