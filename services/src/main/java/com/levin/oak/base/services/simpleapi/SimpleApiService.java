 ...
 * 简单动态接口-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:07, 代码生成哈希校验码：[a8237c5f70328cddb3dd6e003f4ed909]，请不要修改和删除此行内容。
 *
 */
...
public interface SimpleApiService {
    ...
    String CACHE_NAME = ModuleOption.ID + CACHE_DELIM + E_SimpleApi.SIMPLE_CLASS_NAME;

    //缓存key前缀
    String CK_PREFIX = E_SimpleApi.CACHE_KEY_PREFIX;

    //缓存key前缀Spel表达式
    String CK_PREFIX_EXPR = E_SimpleApi.CACHE_KEY_PREFIX_EXPR;

    String SERVICE_NAME = "SimpleApiService";
    ...
    */
    ...
    boolean update(@NotNull UpdateSimpleApiReq req, Object... queryObjs);
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateSimpleApiReq setReq, QuerySimpleApiReq whereReq, Object... queryObjs);
    ...
    PagingData<SimpleApiInfo> selectQuery(@NotNull QuerySimpleApiReq req, Paging paging, String... selectColumnNames);
    ...
    */
    @Operation(summary = QUERY_ACTION + "-指定列", description = "通常用于字段过多的情况，提升性能")
    default PagingData<SimpleApiInfo> selectQuery(@NotNull QuerySimpleApiReq req, Paging paging, PFunction<SimpleApi,?>... selectColumns){
    ...
    int count(@NotNull QuerySimpleApiReq req, Object... queryObjs);
    ...
    */
     ...
     */
    @Operation(summary = QUERY_ACTION)
    SimpleApiInfo findOne(@NotNull QuerySimpleApiReq req, Object... queryObjs);
