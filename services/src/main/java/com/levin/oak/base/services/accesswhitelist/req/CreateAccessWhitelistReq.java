 ...
 * 新增访问白名单
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月9日 下午10:46:12, 代码生成哈希校验码：[af8fc07e4630d44cad978ec3cef7ce25]，请不要修改和删除此行内容。
 *
 */
...
public class CreateAccessWhitelistReq extends MultiTenantReq<CreateAccessWhitelistReq> {
