 ...
 * 访问日志-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:08, 代码生成哈希校验码：[e558dc566b9be241937bfb59cc19d635]，请不要修改和删除此行内容。
 *
 */
...
public interface AccessLogService {
    ...
    String CACHE_NAME = ModuleOption.ID + CACHE_DELIM + E_AccessLog.SIMPLE_CLASS_NAME;

    //缓存key前缀
    String CK_PREFIX = E_AccessLog.CACHE_KEY_PREFIX;

    //缓存key前缀Spel表达式
    String CK_PREFIX_EXPR = E_AccessLog.CACHE_KEY_PREFIX_EXPR;
    ...
    */
    ...
    boolean update(@NotNull UpdateAccessLogReq req, Object... queryObjs);
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateAccessLogReq setReq, QueryAccessLogReq whereReq, Object... queryObjs);
    ...
    PagingData<AccessLogInfo> selectQuery(@NotNull QueryAccessLogReq req, Paging paging, String... selectColumnNames);
    ...
    */
    @Operation(summary = QUERY_ACTION + "-指定列", description = "通常用于字段过多的情况，提升性能")
    default PagingData<AccessLogInfo> selectQuery(@NotNull QueryAccessLogReq req, Paging paging, PFunction<AccessLog,?>... selectColumns){
    ...
    int count(@NotNull QueryAccessLogReq req, Object... queryObjs);
    ...
    */
     ...
     */
    @Operation(summary = QUERY_ACTION)
    AccessLogInfo findOne(@NotNull QueryAccessLogReq req, Object... queryObjs);
