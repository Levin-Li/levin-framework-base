 ...
 * 租户应用 主键通用请求
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月28日 上午11:04:41, 代码生成哈希校验码：[4a90c69b767ce5cec841aa813534e219]，请不要修改和删除此行内容。
 *
 */
...
public class TenantAppIdReq extends MultiTenantReq<TenantAppIdReq> {
