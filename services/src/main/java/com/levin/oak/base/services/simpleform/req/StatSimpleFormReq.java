 ...
 * 统计简单表单
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月17日 上午2:26:22, 代码生成哈希校验码：[50e0ba8cbc3954a36328c9cdc1c93878]，请不要修改和删除此行内容。
 */
...
public class StatSimpleFormReq extends QuerySimpleFormReq {
    ...
    public static class Result implements Serializable {
        ...
        // @GroupBy(condition = "#isGroupByDate", value = "date_format(" + E_SimpleForm.createDate +
        ...
        // @Count(fieldCases = {@Case(column = E_SimpleForm.status, whenOptions =
