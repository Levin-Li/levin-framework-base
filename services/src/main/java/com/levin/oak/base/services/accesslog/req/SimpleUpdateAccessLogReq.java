 ...
 * 更新访问日志
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月18日 下午3:51:27, 代码生成哈希校验码：[f39c56b5e818eb8518a93c2484b7495d]，请不要修改和删除此行内容。
 *
 */
...
public class SimpleUpdateAccessLogReq extends MultiTenantOrgReq<SimpleUpdateAccessLogReq> {
    ...
    */
    ...
    public <T extends SimpleUpdateAccessLogReq> T setModule(String module) {
        this.module = module;
        return addUpdateField(E_AccessLog.module);
    }
