 ...
 * 访问白名单 主键通用请求
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月9日 下午10:46:12, 代码生成哈希校验码：[b37aa58a22c1e8957665647488179784]，请不要修改和删除此行内容。
 *
 */
...
public class AccessWhitelistIdReq extends MultiTenantReq<AccessWhitelistIdReq> {
    ...
    public AccessWhitelistIdReq updateIdWhenNotBlank(String id){
        if(isNotBlank(id)){
            this.id = id;
        }
        return this;
