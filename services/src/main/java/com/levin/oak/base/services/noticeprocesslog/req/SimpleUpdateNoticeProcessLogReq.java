 ...
 * 更新通知处理日志
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月11日 下午5:00:20, 代码生成哈希校验码：[246ef9386f9fc52388e03b05bd4ddf11]，请不要修改和删除此行内容。
 *
 */
...
public class SimpleUpdateNoticeProcessLogReq extends MultiTenantOrgReq<SimpleUpdateNoticeProcessLogReq> {
    ...
    public SimpleUpdateNoticeProcessLogReq() {
    ...
    * @param forceUpdate
    */
    public SimpleUpdateNoticeProcessLogReq(boolean forceUpdate) {
    ...
    public <T extends SimpleUpdateNoticeProcessLogReq> T setNoticeId(String noticeId) {
    ...
    public <T extends SimpleUpdateNoticeProcessLogReq> T setRemark(String remark) {
        this.remark = remark;
        return addUpdateField(E_NoticeProcessLog.remark);
    }
    public <T extends SimpleUpdateNoticeProcessLogReq> T setOptimisticLock(Integer optimisticLock) {
        this.optimisticLock = optimisticLock;
        return addUpdateField(E_NoticeProcessLog.optimisticLock);
    }
    ...
    */
    public <T extends SimpleUpdateNoticeProcessLogReq> T removeUpdateField(String fieldName) {
