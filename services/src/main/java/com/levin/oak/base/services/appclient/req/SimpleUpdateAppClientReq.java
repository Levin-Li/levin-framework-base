 ...
 * 代码生成哈希校验码：[02d784e19f4cd4a094a4b7a342d2aa61], 请不要修改和删除此行内容。
 */
...
public class SimpleUpdateAppClientReq extends MultiTenantOrgReq {
    ...
    public SimpleUpdateAppClientReq(String id) {
        this.id = id;
    }

    public SimpleUpdateAppClientReq updateIdWhenNotBlank(String id){
        if(isNotBlank(id)){
        this.id = id;
        }
        return this;
