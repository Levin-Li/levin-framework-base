package com.levin.oak.base.biz.bo.whitelist;
 ...
 * 统计白名单
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月2日 下午8:20:51, 代码生成哈希校验码：[9f0333d10be1dd8f55623a94f902d8e4]，请不要修改和删除此行内容。
 *
 */
...
@TargetOption(entityClass = Whitelist.class, alias = E_Whitelist.ALIAS,
    ...
    resultClass = StatWhitelistReq.Result.class
)
public class StatWhitelistReq extends QueryWhitelistReq{
    ...
    public static class Result
        ...
        //@GroupBy(condition = "#isGroupByDate", value = "date_format(" + E_Whitelist.createDate + ",'%Y-%m-%d')", orderBy = @OrderBy(type = OrderBy.Type.Asc))
        //String createDate;
        ...
        //@Count(fieldCases = {@Case(column = E_Whitelist.status, whenOptions = {@Case.When(whenExpr = "OFF", thenExpr = "1")}, elseExpr = "NULL")})
        //Integer caseCnt;
