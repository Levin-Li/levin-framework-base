 ...
 * 通知-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月28日 下午3:56:02, 代码生成哈希校验码：[18af4b7778400eea4c8055fe8d358e8b]，请不要修改和删除此行内容。
 *
 */
...
public interface NoticeService {
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateNoticeReq setReq, QueryNoticeReq whereReq);
    ...
    PagingData<NoticeInfo> selectQuery(@NotNull QueryNoticeReq req, Paging paging, String... columnNames);
