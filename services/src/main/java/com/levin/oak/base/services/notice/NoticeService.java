 ...
 * 通知-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:07, 代码生成哈希校验码：[02981428912241949680d665a892fb9b]，请不要修改和删除此行内容。
 *
 */
...
public interface NoticeService {
    ...
    String CACHE_NAME = ModuleOption.ID + CACHE_DELIM + E_Notice.SIMPLE_CLASS_NAME;

    //缓存key前缀
    String CK_PREFIX = E_Notice.CACHE_KEY_PREFIX;

    //缓存key前缀Spel表达式
    String CK_PREFIX_EXPR = E_Notice.CACHE_KEY_PREFIX_EXPR;

    String SERVICE_NAME = "NoticeService";
    ...
    */
    ...
    boolean update(@NotNull UpdateNoticeReq req, Object... queryObjs);
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateNoticeReq setReq, QueryNoticeReq whereReq, Object... queryObjs);
    ...
    PagingData<NoticeInfo> query(@NotNull QueryNoticeReq req, Paging paging, Object... queryObjs);
    ...
    PagingData<NoticeInfo> selectQuery(@NotNull QueryNoticeReq req, Paging paging, String... selectColumnNames);
    ...
    */
    @Operation(summary = QUERY_ACTION + "-指定列", description = "通常用于字段过多的情况，提升性能")
    default PagingData<NoticeInfo> selectQuery(@NotNull QueryNoticeReq req, Paging paging, PFunction<Notice,?>... selectColumns){
    ...
    int count(@NotNull QueryNoticeReq req, Object... queryObjs);
    ...
    */
     ...
     */
    @Operation(summary = QUERY_ACTION)
    NoticeInfo findOne(@NotNull QueryNoticeReq req, Object... queryObjs);
