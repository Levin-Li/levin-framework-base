 ...
 * 访问日志 主键通用请求
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月11日 下午5:00:20, 代码生成哈希校验码：[b875a115e99f3dbe45ac59d5d19156df]，请不要修改和删除此行内容。
 *
 */
...
public class AccessLogIdReq extends MultiTenantOrgReq<AccessLogIdReq> {
