 ...
 * 查询简单页面
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月25日 下午12:47:03, 代码生成哈希校验码：[3f59606a096247bb4a481d10f8df788c]，请不要修改和删除此行内容。
 *
 */
...
public class QuerySimplePageReq extends MultiTenantOrgReq<QuerySimplePageReq> {
