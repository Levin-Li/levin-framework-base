 ...
 * 应用错误日志-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月9日 上午10:26:26, 代码生成哈希校验码：[cb05fe2878f7040cf86adf2e76bf43b2]，请不要修改和删除此行内容。
 *
 */
...
public interface AppErrorLogService {
    ...
    String CK_PREFIX = E_AppErrorLog.CACHE_KEY_PREFIX;

    String SERVICE_NAME = "AppErrorLogService";
    ...
    boolean update(@NotNull UpdateAppErrorLogReq req, Object... queryObjs);
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateAppErrorLogReq setReq, QueryAppErrorLogReq whereReq);
    ...
    PagingData<AppErrorLogInfo> selectQuery(@NotNull QueryAppErrorLogReq req, Paging paging, String... columnNames);
    ...
    */
     ...
     */
    @Operation(summary = QUERY_ACTION)
    AppErrorLogInfo findUnique(QueryAppErrorLogReq req);
