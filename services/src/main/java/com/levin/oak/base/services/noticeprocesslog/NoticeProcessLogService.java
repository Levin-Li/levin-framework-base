 ...
 * 通知处理日志-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月7日 上午11:03:11, 代码生成哈希校验码：[9aa6a9dac89fd3622c1c98dd9bb313a5]，请不要修改和删除此行内容。
 *
 */
...
public interface NoticeProcessLogService {
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int update(@NotNull SimpleUpdateNoticeProcessLogReq setReq, QueryNoticeProcessLogReq whereReq);
