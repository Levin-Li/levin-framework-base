 ...
 * 通知处理日志-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:08, 代码生成哈希校验码：[18880cbdc24e90ea75c15227dbfa7ef7]，请不要修改和删除此行内容。
 *
 */
...
public interface NoticeProcessLogService {
    ...
    String CACHE_NAME = ModuleOption.ID + CACHE_DELIM + E_NoticeProcessLog.SIMPLE_CLASS_NAME;

    //缓存key前缀
    String CK_PREFIX = E_NoticeProcessLog.CACHE_KEY_PREFIX;

    //缓存key前缀Spel表达式
    String CK_PREFIX_EXPR = E_NoticeProcessLog.CACHE_KEY_PREFIX_EXPR;

    String SERVICE_NAME = "NoticeProcessLogService";
    ...
    */
    ...
    boolean update(@NotNull UpdateNoticeProcessLogReq req, Object... queryObjs);
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateNoticeProcessLogReq setReq, QueryNoticeProcessLogReq whereReq, Object... queryObjs);
    ...
    boolean delete(@NotNull NoticeProcessLogIdReq req);
    ...
    PagingData<NoticeProcessLogInfo> query(@NotNull QueryNoticeProcessLogReq req, Paging paging, Object... queryObjs);
    ...
    PagingData<NoticeProcessLogInfo> selectQuery(@NotNull QueryNoticeProcessLogReq req, Paging paging, String... selectColumnNames);
    ...
    */
    @Operation(summary = QUERY_ACTION + "-指定列", description = "通常用于字段过多的情况，提升性能")
    default PagingData<NoticeProcessLogInfo> selectQuery(@NotNull QueryNoticeProcessLogReq req, Paging paging, PFunction<NoticeProcessLog,?>... selectColumns){
    ...
    int count(@NotNull QueryNoticeProcessLogReq req, Object... queryObjs);
    ...
    */
     ...
     */
    @Operation(summary = QUERY_ACTION)
    NoticeProcessLogInfo findOne(@NotNull QueryNoticeProcessLogReq req, Object... queryObjs);
