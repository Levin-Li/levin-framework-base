 ...
 * 删除国际化资源
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月27日 下午3:55:27, 代码生成哈希校验码：[75316997047832c4562a58fdf011c7fc]，请不要修改和删除此行内容。
 *
 */
...
public class DeleteI18nResReq extends MultiTenantReq<DeleteI18nResReq> {
