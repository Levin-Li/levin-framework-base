 ...
 * 删除动态验证码配置
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月9日 下午10:46:13, 代码生成哈希校验码：[605574efa7b5e8a362fa321714fbddee]，请不要修改和删除此行内容。
 *
 */
...
public class DeleteDynamicVerifyCodeCfgReq extends MultiTenantReq<DeleteDynamicVerifyCodeCfgReq> {
    ...
    public DeleteDynamicVerifyCodeCfgReq(String... idList) {
        this.idList = idList;
    }

    public DeleteDynamicVerifyCodeCfgReq setIdList(String... idList) {
        this.idList = idList;
        return this;
    }
