 ...
 * 系统设置-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:07, 代码生成哈希校验码：[90ef87fc5d92f30fd1281cb2cc105fe5]，请不要修改和删除此行内容。
 *
 */
...
public interface SettingService {
    ...
    String CACHE_NAME = ModuleOption.ID + CACHE_DELIM + E_Setting.SIMPLE_CLASS_NAME;

    //缓存key前缀
    String CK_PREFIX = E_Setting.CACHE_KEY_PREFIX;

    //缓存key前缀Spel表达式
    String CK_PREFIX_EXPR = E_Setting.CACHE_KEY_PREFIX_EXPR;
    ...
    */
    ...
    boolean update(@NotNull UpdateSettingReq req, Object... queryObjs);
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateSettingReq setReq, QuerySettingReq whereReq, Object... queryObjs);
    ...
    PagingData<SettingInfo> query(@NotNull QuerySettingReq req, Paging paging, Object... queryObjs);
    ...
    PagingData<SettingInfo> selectQuery(@NotNull QuerySettingReq req, Paging paging, String... selectColumnNames);
    ...
    */
    @Operation(summary = QUERY_ACTION + "-指定列", description = "通常用于字段过多的情况，提升性能")
    default PagingData<SettingInfo> selectQuery(@NotNull QuerySettingReq req, Paging paging, PFunction<Setting,?>... selectColumns){
    ...
    int count(@NotNull QuerySettingReq req, Object... queryObjs);
    ...
    */
     ...
     */
    @Operation(summary = QUERY_ACTION)
    SettingInfo findOne(@NotNull QuerySettingReq req, Object... queryObjs);
