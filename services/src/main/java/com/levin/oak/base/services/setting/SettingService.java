 ...
 * 系统设置-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月28日 下午3:56:02, 代码生成哈希校验码：[71c8d97fcdb34df52261c1af8599ed9b]，请不要修改和删除此行内容。
 *
 */
...
public interface SettingService {
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateSettingReq setReq, QuerySettingReq whereReq);
    ...
    PagingData<SettingInfo> selectQuery(@NotNull QuerySettingReq req, Paging paging, String... columnNames);
