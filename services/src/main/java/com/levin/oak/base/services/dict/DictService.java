 ...
 * 字典-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:07, 代码生成哈希校验码：[97eb5462042ba42dee23e31ed71c1678]，请不要修改和删除此行内容。
 *
 */
...
public interface DictService {
    ...
    String CACHE_NAME = ModuleOption.ID + CACHE_DELIM + E_Dict.SIMPLE_CLASS_NAME;

    //缓存key前缀
    String CK_PREFIX = E_Dict.CACHE_KEY_PREFIX;

    //缓存key前缀Spel表达式
    String CK_PREFIX_EXPR = E_Dict.CACHE_KEY_PREFIX_EXPR;

    String SERVICE_NAME = "DictService";
    ...
    */
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateDictReq setReq, QueryDictReq whereReq, Object... queryObjs);
    ...
    boolean delete(@NotNull DictIdReq req);
    ...
    PagingData<DictInfo> query(@NotNull QueryDictReq req, Paging paging, Object... queryObjs);
    ...
    PagingData<DictInfo> selectQuery(@NotNull QueryDictReq req, Paging paging, String... selectColumnNames);
    ...
    */
    @Operation(summary = QUERY_ACTION + "-指定列", description = "通常用于字段过多的情况，提升性能")
    default PagingData<DictInfo> selectQuery(@NotNull QueryDictReq req, Paging paging, PFunction<Dict,?>... selectColumns){
    ...
    int count(@NotNull QueryDictReq req, Object... queryObjs);
    ...
    */
     ...
     */
    @Operation(summary = QUERY_ACTION)
    DictInfo findOne(@NotNull QueryDictReq req, Object... queryObjs);
