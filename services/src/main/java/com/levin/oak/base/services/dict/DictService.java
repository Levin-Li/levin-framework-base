 ...
 * 字典-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月28日 下午3:56:02, 代码生成哈希校验码：[2c2abd3940fbe08190342f8241b54087]，请不要修改和删除此行内容。
 *
 */
...
public interface DictService {
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateDictReq setReq, QueryDictReq whereReq);
    ...
    int count(@NotNull QueryDictReq req);
