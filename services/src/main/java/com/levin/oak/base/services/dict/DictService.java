 ...
 * 字典-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年12月8日 下午11:11:15, 代码生成哈希校验码：[f8b8fb781196b2d5a3030793a7f17f44]，请不要修改和删除此行内容。
 *
 */
...
public interface DictService {
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int update(@NotNull SimpleUpdateDictReq setReq, QueryDictReq whereReq);
