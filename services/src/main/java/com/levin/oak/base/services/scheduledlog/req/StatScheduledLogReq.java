 ...
 * 统计调度日志
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月17日 上午2:26:20, 代码生成哈希校验码：[4c461ed569d7410ad34bb9bb0b057636]，请不要修改和删除此行内容。
 */
...
public class StatScheduledLogReq extends QueryScheduledLogReq {
    ...
    public static class Result implements Serializable {
        ...
        // @GroupBy(condition = "#isGroupByDate", value = "date_format(" + E_ScheduledLog.createDate
        ...
        // @Count(fieldCases = {@Case(column = E_ScheduledLog.status, whenOptions =
