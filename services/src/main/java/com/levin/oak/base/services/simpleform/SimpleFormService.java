 ...
 * 简单表单-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2023年11月25日 下午1:13:57, 代码生成哈希校验码：[ed36d88d4ae40077b04732529bdd7efb]，请不要修改和删除此行内容。
 *
 */
...
public interface SimpleFormService {
    ...
    boolean update(@NotNull UpdateSimpleFormReq req);
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int update(@NotNull SimpleUpdateSimpleFormReq setReq, QuerySimpleFormReq whereReq);
    ...
    PagingData<SimpleSimpleFormInfo> simpleQuery(@NotNull QuerySimpleFormReq req, Paging paging);
    ...
    PagingData<StatSimpleFormReq.Result> stat(@NotNull StatSimpleFormReq req, Paging paging);
