 ...
 * 简单表单-服务接口
 *
 * @author Auto gen by simple-dao-codegen, @time: 2024年3月29日 上午12:46:08, 代码生成哈希校验码：[6d10262c0fbb8bf4e26235f7c075a941]，请不要修改和删除此行内容。
 *
 */
...
public interface SimpleFormService {
    ...
    String CACHE_NAME = ModuleOption.ID + CACHE_DELIM + E_SimpleForm.SIMPLE_CLASS_NAME;

    //缓存key前缀
    String CK_PREFIX = E_SimpleForm.CACHE_KEY_PREFIX;

    //缓存key前缀Spel表达式
    String CK_PREFIX_EXPR = E_SimpleForm.CACHE_KEY_PREFIX_EXPR;
    ...
    */
     ...
     */
    @Operation(summary = UPDATE_ACTION)
    int batchUpdate(@NotNull SimpleUpdateSimpleFormReq setReq, QuerySimpleFormReq whereReq, Object... queryObjs);
    ...
    PagingData<SimpleFormInfo> selectQuery(@NotNull QuerySimpleFormReq req, Paging paging, String... selectColumnNames);
    ...
    */
    @Operation(summary = QUERY_ACTION + "-指定列", description = "通常用于字段过多的情况，提升性能")
    default PagingData<SimpleFormInfo> selectQuery(@NotNull QuerySimpleFormReq req, Paging paging, PFunction<SimpleForm,?>... selectColumns){
    ...
    int count(@NotNull QuerySimpleFormReq req, Object... queryObjs);
    ...
    */
     ...
     */
    @Operation(summary = QUERY_ACTION)
    SimpleFormInfo findOne(@NotNull QuerySimpleFormReq req, Object... queryObjs);
